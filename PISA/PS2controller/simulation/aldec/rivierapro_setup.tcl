...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "PS2controller"
}
...
alias com {
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/PS2controller_ps2_0.v"       -work ps2_0
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PS2controller.v"                                   
}
