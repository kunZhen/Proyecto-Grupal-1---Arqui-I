...
# ACDS 18.1 625 win32 2024.10.20.22:38:26
...
# ----------------------------------------
# If PS2controller is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/PS2controller_ps2_0.v"       -work ps2_0 -cdslib ./cds_libs/ps2_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PS2controller.v"                                                                    
fi
