...
# ACDS 18.1 625 win32 2024.10.21.11:23:42
# ----------------------------------------
...
# ----------------------------------------
# If pllkeyboard is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pllkeyboard"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pllkeyboard.vo"
}
